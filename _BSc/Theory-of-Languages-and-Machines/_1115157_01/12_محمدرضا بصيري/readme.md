...
------------------
##  در دست تکمیل فرم های ارزیابی من📊📈
...
## کارهای پایان ترم📖📗📘📕
- [فایل تایپ لاتک صفحه 45 الی 48 کتاب معرفی شده و ارائه با قالب بیمرصفحه 45 الی 46 کتاب معرفی شده](https://github.com/mrezabasiri/pnu99taklif)
